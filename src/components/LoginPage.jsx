    ...
    <div className="login-page">
      ...
      <div className="login-card">
        <div className="login-logo">
          ...
          <span className="login-logo-name">NooK</span>
        </div>
        <p className="login-subtitle">Family Dashboard</p>
        ...
        <p className="login-hint">Sign in with any family member's Google account</p>
      </div>
    </div>
  )
}
